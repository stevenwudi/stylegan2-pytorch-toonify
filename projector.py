...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", default='./checkpoint/551000.pt', type=str, help="path to the model checkpoint")
    ...
    parser.add_argument("--files", default=['../images/aligned/keke_01.png'], metavar="FILES", nargs="+", help="path to image files to be projected")
